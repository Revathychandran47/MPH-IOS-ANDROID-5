...
public class Utilities_negative_scenario extends Generic_functions{
    ...
    public void open_App_IOS() throws Exception {
        try {
            app_launch();
            page_wait(4000);
    ...
    public void clicks_utilities() throws Exception {
        try {
        	page_wait(9000);
...
// TC001_Validate_leaving_fields_blank_add_card_page
    ...
    public void click_Utilities_wallet() throws Exception {
        try {
    ...
    public void click_add_card() throws Exception {
        try{
    ...
    public void TC001_Validate_leaving_fields_blank_add_card_page() throws Exception {
        try{
    ...
    public void invalid_details_add_card() throws Exception {
        try{
        click_add_card();
        page_wait(4000);
    ...
    public void TC002_validate_message_invalid_details_add_card() throws Exception {
        try{
...
//TC003_Validate message on leaving fields blank in the Add Bank page
    ...
    public void click_add_bank() throws Exception {
        try {
            click("utilities_add_payment_button");
            page_wait(2000);
    ...
    public void leave_field_blank_add_bank() throws Exception {
        try {
    ...
    public void TC003_Validate_message_on_leave_fields_blank_add_bank() throws Exception {
        try{
            page_wait(4000);
...
//TC004_Validate that user gets validation message on entering invalid details in the Add Bank page
    ...
    public void invalid_details_add_bank() throws Exception {
        click("utilities_add_payment_button");
        page_wait(2000);
        click("utilities_add_bank");
    ...
    public void TC004_entering_invalid_details_AddBank_page() throws Exception {
        try{
            text = driver.findElement(By.xpath(OR_reader("utilities_account_holder_name_valid_msg_two"))).getText();
...
//        page_wait(2000);
    ...
    public void TC005_Validate_award_points_page() throws Exception {
        try {
...
//            click("utilities_back");
    ...
    public void click_ID_card() throws Exception {
        try{
//            click("utilities_idcard");
    ...
    public void TC006_verify_ID_card() throws Exception {
        try{
...
//            click("utilities_upload");
    ...
    @Then("Verify Upload")
    public void TC007_verify_upload() throws Exception {
        try{
//            value=driver.findElement(By.xpath(OR_reader("utilities_ok_button"))).isDisplayed();
//            Assert.assertEquals(true,value);
//            click("utilities_ok_button");
